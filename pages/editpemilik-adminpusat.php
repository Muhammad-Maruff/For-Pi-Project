<?php
  ...
  if(isset($_POST['btn-simpan'])){
    if(isset($_GET['hal']) == "edit"){
      $edit = mysqli_query($koneksi, "UPDATE tb_pemilik SET
          ...
          if($edit){
            echo "<script>
              ...
              document.location='pemilik-adminpusat.php'
            </script>";
          }
          else{
            echo "<script>
    ...
    //Data akan disimpan
      ...
      $simpan = mysqli_query($koneksi, "INSERT INTO tb_pemilik (pemilik)
      VALUE (
              '$_POST[tpemilik]'
  ");
...
document.location='pemilik-adminpusat.php'
    ...
    $tampil = mysqli_query($koneksi, "SELECT * FROM tb_pemilik order by id_pemilik asc");
  ...
  if(isset($_GET['hal'])){
    ...
    if($_GET['hal'] == "edit"){
      ...
      $tampil=mysqli_query($koneksi, "SELECT * FROM tb_pemilik WHERE id_pemilik = '$_GET[id]'");
