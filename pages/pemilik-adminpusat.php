...
<head>
  ...
  <title>For-Pi | Master | Pemilik</title>
 ...
 <div class="preloader flex-column justify-content-center align-items-center">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="pemilik-adminpusat.php" class="nav-link">Pemilik</a>
      </li>
    </ul>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="adminpusat.php">Home</a></li>
    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Tambahkan Pemilik</h3>
        ...
        <form action="connect-pemilikpusat.php" method="post">
            <div class="row mb-3">
...
<br>
        ...
        <table class="table table-striped table:hover table-bordered">
            ...
            <tr>
              ...
              <td><?= $data['pemilik'] ?></td>
              <td>
                <a href="editpemilik-adminpusat.php?hal=edit&id=<?=$data['id_pemilik']?>" class="btn btn-warning">Edit</a>

                <a href="deletepemilik-adminpusat.php?hal=delete&id=<?=$data['id_pemilik']?>" class="btn btn-danger" onclick="return confirm('Apakah anda ingin menghapus data ini ?')">Delete</a>
