...
<head>
  ...
  <title>For-Pi | Master | Kategori Satuan</title>
 ...
 <div class="preloader flex-column justify-content-center align-items-center">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="kategori-satuan-adminpusat.php" class="nav-link">Kategori Satuan</a>
      </li>
    </ul>
    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Tambahkan Kategori Satuan </h3>
        ...
        <form action="connect-kategorisatuan-adminpusat.php" method="post">
...
<br>
        <table class="table table-striped table:hover table-bordered">
            ...
            <tr>
              ...
              <td>
              <a href="edit-kategori-satuan-adminpusat.php?hal=edit&id=<?=$data['id_kategori']?>" class="btn btn-warning">Edit</a>
              <a href="delete-kategori-satuan-adminpusat.php?hal=delete&id=<?=$data['id_kategori']?>" class="btn btn-danger" onclick="return confirm('Apakah anda ingin menghapus data ini ?')">Delete</a></td>
            </tr>
            <?php endwhile; ?>
