...
<head>
  ...
  <title>For-Pi | Master | Frekuensi</title>
  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <form action="connect-frekuensi-adminpusat.php" method="post">
...
<br>
        ...
        <table class="table table-striped table:hover table-bordered">
            ...
            <tr>
              ...
              <td>
                <a href="editfrekuensi-adminpusat.php?hal=edit&id=<?=$data['id_frekuensi']?>" class="btn btn-warning">Edit</a>

                <a href="deletefrekuensi-adminpusat.php?hal=delete&id=<?=$data['id_frekuensi']?>" class="btn btn-danger" onclick="return confirm('Apakah anda ingin menghapus data ini ?')">Delete</a>
