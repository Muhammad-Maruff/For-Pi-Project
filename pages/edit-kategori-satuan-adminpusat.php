<?php
  ...
  if(isset($_POST['btn-simpan'])){
    if(isset($_GET['hal']) == "edit"){
      ...
      $edit = mysqli_query($koneksi, "UPDATE tb_kategori SET
          ...
          if($edit){
            echo "<script>
              ...
              document.location='kategori-satuan-adminpusat.php'
            </script>";
          }
          else{
            echo "<script>
    ...
    //Data akan disimpan
      ...
      $simpan = mysqli_query($koneksi, "INSERT INTO tb_kategori (kategori_satuan)
      VALUE ( ]
              '$_POST[tkategori]',
...
document.location='kategori-superadmin.php';
</script>";
} else{
echo "<script>
...
document.location='kategori-superadmin.php';
    ...
    $tampil = mysqli_query($koneksi, "SELECT * FROM tb_kategori order by id_kategori asc");
  ...
  if(isset($_GET['hal'])){
    ...
    if($_GET['hal'] == "edit"){
      ...
      if($data){
        ...
        $vkategori = $data['kategori_satuan'];
...
logout
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="tkategori" value="<?= $vkategori ?>">
    </div>
  </div>
