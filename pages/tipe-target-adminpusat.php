...
<head>
  ...
  <title>For-Pi | Master | Tipe Target</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tipe Target</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Tambahkan Tipe Target</h3>
        ...
        <form action="connect-tipetarget-adminpusat.php" method="post">
...
<br>
        ...
        <table class="table table-striped table:hover table-bordered">
            ...
            <tr>
              ...
              <td>
              <a href="edit-tipe-target-adminpusat.php?hal=edit&id=<?=$data['id_tipetarget']?>" class="btn btn-warning">Edit</a>
              <a href="delete-tipe-target-adminpusat.php?hal=delete&id=<?=$data['id_tipetarget']?>" class="btn btn-danger" onclick="return confirm('Apakah anda ingin menghapus data ini ?')">Delete</a>
            </td>
            </tr>
            <?php endwhile; ?>
