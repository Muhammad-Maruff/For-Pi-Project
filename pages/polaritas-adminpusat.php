 ...
 <div class="preloader flex-column justify-content-center align-items-center">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="polaritas-adminpusat.php" class="nav-link">Polaritas</a>
      </li>
    </ul>
  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <form action="connect-polaritas-adminpusat.php" method="post">
...
<br>
        <table class="table table-striped table:hover table-bordered">
            ...
            <tr>
              ...
              <td>
              <a href="editpolaritas-adminpusat.php?hal=edit&id=<?=$data['id_polaritas']?>" class="btn btn-warning">Edit</a>
              <a href="deletepolaritas-adminpusat.php?hal=delete&id=<?=$data['id_polaritas']?>" class="btn btn-danger" onclick="return confirm('Apakah anda ingin menghapus data ini ?')">Delete</a>
              </td>
            </tr>
            <?php endwhile; ?>
