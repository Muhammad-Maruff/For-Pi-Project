<?php
  ...
  if(isset($_GET['hal'])){
    ...
    if($_GET['hal'] == "delete"){
      ...
      $hapus = mysqli_query($koneksi, "DELETE FROM tb_tipekpi WHERE id_kpi = '$_GET[id]'");
      //jika hapus sukses
      if($hapus){
        echo "<script>
        alert('data berhasil dihapus!');
        document.location='tipe-kpi-adminpusat.php';
        </script>";
        } else{
        echo "<script>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="admin-pusat.php">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="juknis-adminpusat.php">Juknis</a>
            </li>
            <li class="nav-item">
